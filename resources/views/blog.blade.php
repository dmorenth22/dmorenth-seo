			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="post">
								<a class="post-img" href="#"><img src="{{$new_post->gambar}}" alt=""></a>
								<div class="post-body">
									<div class="post-category">
										<a href="#">{{$new_post->category['name']}}</a>
									</div>
									<h3 class="post-title"><a href="blog-post.html">{{$new_post->judul}}</a></h3>
									<ul class="post-meta">
										<li><a href="#">{{$new_post->users->name}}</a></li>
										<li>{{$new_post->created_at}}</li>
									</ul>
								</div>
							</div>
						</div>
